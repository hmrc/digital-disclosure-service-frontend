...
object WhereDidTheUndeclaredIncomeOrGainSummary  {

  def row(answers: UserAnswers)(implicit messages: Messages): Option[SummaryListRow] =
    answers.get(WhereDidTheUndeclaredIncomeOrGainPage).map {
      answer =>
        ...
        SummaryListRowViewModel(
          ...
          actions = Seq(
            ActionItemViewModel("site.change", routes.WhereDidTheUndeclaredIncomeOrGainController.onPageLoad(CheckMode).url)
