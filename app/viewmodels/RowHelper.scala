...
trait RowHelper {
  ...
  def poundRowCase(i: Int, label: String, value: String, hiddenLabel: String, section: RowHelperSection)(implicit
    messages: Messages
  ) =
    section match {
  ...
  def rowCase(
    ...
    value: String,
    hiddenLabel: String,
    section: RowHelperSection,
    revealFullText: RevealFullText,
    isRevealText: Boolean
  )(implicit messages: Messages) =
    section match {
      case ONSHORE  =>
        if (isRevealText)
          onshoreRevealRow(i: Int, label: String, value: String, hiddenLabel: String, revealFullText: RevealFullText)
        else onshoreRow(i: Int, label: String, value: String, hiddenLabel: String)
      case OFFSHORE =>
        if (isRevealText)
          offshoreRevealRow(i: Int, label: String, value: String, hiddenLabel: String, revealFullText: RevealFullText)
        else offshoreRow(i: Int, label: String, value: String, hiddenLabel: String)
      case CT       =>
        if (isRevealText)
          ctRevealRow(i: Int, label: String, value: String, hiddenLabel: String, revealFullText: RevealFullText)
        else ctRow(i: Int, label: String, value: String, hiddenLabel: String)
      case DL       =>
        if (isRevealText)
          dlRevealRow(i: Int, label: String, value: String, hiddenLabel: String, revealFullText: RevealFullText)
        else dlRow(i: Int, label: String, value: String, hiddenLabel: String)
    }
  ...
  private def onshorePoundRow(i: Int, label: String, value: String, hiddenLabel: String)(implicit messages: Messages) =
    SummaryListRowViewModel(
      ...
      actions = Seq(
        ActionItemViewModel(
          "site.change",
          controllers.onshore.routes.OnshoreTaxYearLiabilitiesController.onPageLoad(i, CheckMode).url
        )
  ...
  private def offshorePoundRow(i: Int, label: String, value: String, hiddenLabel: String)(implicit messages: Messages) =
    SummaryListRowViewModel(
      ...
      actions = Seq(
        ActionItemViewModel(
          "site.change",
          controllers.offshore.routes.TaxYearLiabilitiesController.onPageLoad(i, CheckMode).url
        )
          .withVisuallyHiddenText(messages(hiddenLabel))
      )
    )
  ...
  private def ctPoundRow(i: Int, label: String, value: String, hiddenLabel: String)(implicit messages: Messages) =
    SummaryListRowViewModel(
      ...
      actions = Seq(
        ActionItemViewModel(
          "site.change",
          controllers.onshore.routes.CorporationTaxLiabilityController.onPageLoad(i, CheckMode).url
        )
          .withVisuallyHiddenText(messages(hiddenLabel))
      )
    )
  ...
  private def dlPoundRow(i: Int, label: String, value: String, hiddenLabel: String)(implicit messages: Messages) =
    SummaryListRowViewModel(
      ...
      actions = Seq(
        ActionItemViewModel(
          "site.change",
          controllers.onshore.routes.DirectorLoanAccountLiabilitiesController.onPageLoad(i, CheckMode).url
        )
          .withVisuallyHiddenText(messages(hiddenLabel))
      )
    )
  ...
  private def ctRevealRow(i: Int, label: String, value: String, hiddenLabel: String, revealFullText: RevealFullText)(
    implicit messages: Messages
  ) =
    SummaryListRowViewModel(
      key = s"$label.checkYourAnswersLabel",
  ...
  def dlRevealRow(i: Int, label: String, value: String, hiddenLabel: String, revealFullText: RevealFullText)(implicit
    messages: Messages
  ) =
    SummaryListRowViewModel(
      key = s"$label.checkYourAnswersLabel",
