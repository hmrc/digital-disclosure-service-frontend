...
class WhatIsTheCompanyRegistrationNumberController @Inject()(
                                        ...
                                        formProvider: WhatIsTheCompanyRegistrationNumberFormProvider,
                                        val controllerComponents: MessagesControllerComponents,
                                        view: WhatIsTheCompanyRegistrationNumberView
  ...
  def onPageLoad(mode: Mode): Action[AnyContent] = (identify andThen getData andThen requireData) {
    implicit request =>
      ...
      val preparedForm = request.userAnswers.get(WhatIsTheCompanyRegistrationNumberPage) match {
        case None => form
  ...
  def onSubmit(mode: Mode): Action[AnyContent] = (identify andThen getData andThen requireData).async {
    implicit request =>
      ...
      form.bindFromRequest().fold(
        ...
        value =>
          for {
            updatedAnswers <- Future.fromTry(request.userAnswers.set(WhatIsTheCompanyRegistrationNumberPage, value))
