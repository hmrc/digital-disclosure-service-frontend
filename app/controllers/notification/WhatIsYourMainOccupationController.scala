...
class WhatIsYourMainOccupationController @Inject()(
                                        ...
                                        formProvider: WhatIsYourMainOccupationFormProvider,
                                        val controllerComponents: MessagesControllerComponents,
                                        view: WhatIsYourMainOccupationView
  ...
  def onPageLoad(mode: Mode): Action[AnyContent] = (identify andThen getData andThen requireData) {
    implicit request =>
      ...
      val preparedForm = request.userAnswers.get(WhatIsYourMainOccupationPage) match {
        case None => form
