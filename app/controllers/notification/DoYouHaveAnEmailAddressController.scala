...
class DoYouHaveAnEmailAddressController @Inject()(
                                         ...
                                         formProvider: DoYouHaveAnEmailAddressFormProvider,
                                         val controllerComponents: MessagesControllerComponents,
                                         view: DoYouHaveAnEmailAddressView
  ...
  def onPageLoad(mode: Mode): Action[AnyContent] = (identify andThen getData andThen requireData) {
    implicit request =>
      ...
      val preparedForm = request.userAnswers.get(DoYouHaveAnEmailAddressPage) match {
        case None => form
