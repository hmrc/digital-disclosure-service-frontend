...
taxYearLiabilities.undeclaredIncomeOrGain.reveal = Show where the income or gain came from
...
onshoreTaxYearLiabilities.title = Onshore liabilities — Tax year 6 Ebrill {0} i 5 Ebrill {1}
onshoreTaxYearLiabilities.heading = Onshore liabilities — Tax year 6 Ebrill {0} i 5 Ebrill {1}
...
corporationTaxLiability.howMuchIncome.error.outOfRange = Mae’n rhaid i swm yr incwm fod yn 0 neu’n fwy
...
checkYourAnswers.onshore.taxYear.heading = Tax year 6 Ebrill {0} i 5 Ebrill {1}
...
propertyIsNoLongerBeingLetOut.stopDate.error.required.all = Enter the date of when the property was no longer being let out
...
areYouAMemberOfAnyLandlordAssociations.you.error.required = Select yes if you are a member of any landlord associations
