...
class TaskListViewSpec extends ViewSpecBase with ViewMatchers with Generators {
  ...
  "view with incomplete passed" should {
    ...
    def createView: Html =
      page(list, notificationSectionKey, isTheUserAgent, entity, false, 0, false, title, heading)(using request, messages)
  ...
  "view with completed passed" should {
    ...
    def createView: Html =
      page(list, notificationSectionKey, isTheUserAgent, entity, true, 3, false, title, heading)(using request, messages)
