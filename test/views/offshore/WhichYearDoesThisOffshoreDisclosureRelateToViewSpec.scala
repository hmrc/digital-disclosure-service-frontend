...
class WhichYearDoesThisOffshoreDisclosureRelateToViewSpec extends ViewSpecBase with ViewMatchers {
  ...
  "view" should {
    ...
    "have title" in {
      view.select("title").text() must include(messages("whichYearDoesThisOffshoreDisclosureRelateTo.title"))
    }
