...
class TaxYearLiabilitiesViewSpec extends ViewSpecBase with ViewMatchers {
  ...
  "view" should {
    ...
    "contain the income question" in {
      view.getElementsByClass("govuk-label--m").get(0).text() mustBe messages("taxYearLiabilities.income.question", "2021", "2022")
    }

    "contain the chargeableTransfers question" in {
      view.getElementsByClass("govuk-label--m").get(1).text() mustBe messages("taxYearLiabilities.chargeableTransfers.question", "2021", "2022")
    }

    "contain the capitalGains question" in {
      view.getElementsByClass("govuk-label--m").get(2).text() mustBe messages("taxYearLiabilities.capitalGains.question", "2021", "2022")
    }

    "contain the unpaidTax question" in {
      view.getElementsByClass("govuk-label--m").get(3).text() mustBe messages("taxYearLiabilities.unpaidTax.question", "2021", "2022")
    }

    "contain the interest question" in {
      view.getElementsByClass("govuk-label--m").get(4).text() mustBe messages("taxYearLiabilities.interest.question", "2021", "2022")
    }

    "contain the penaltyRate question" in {
      view.getElementsByClass("govuk-label--m").get(5).text() mustBe messages("taxYearLiabilities.penaltyRate.question", "2021", "2022")
    }

    "contain the foreignTaxCredit question" in {
      view.getElementsByClass("govuk-fieldset__legend--m").text() mustBe messages("taxYearLiabilities.foreignTaxCredit.question", "2021", "2022")
    }
