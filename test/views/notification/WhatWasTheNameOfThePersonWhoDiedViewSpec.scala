...
class WhatWasTheNameOfThePersonWhoDiedViewSpec extends ViewSpecBase with ViewMatchers {
  ...
  "view" should {
    ...
    "have title" in {
      view.select("title").text() must include(messages("whatWasTheNameOfThePersonWhoDied.title"))
    }

    "contain header" in {
      view.getElementsByClass("govuk-heading-xl").text() mustBe messages("whatWasTheNameOfThePersonWhoDied.heading")
    }
