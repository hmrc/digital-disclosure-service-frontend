...
class OnshoreLiabilitiesControllerSpec extends SpecBase with MockitoSugar {
  ...
  lazy val onshoreLiabilitiesRoute = controllers.notification.routes.OnshoreLiabilitiesController.onPageLoad(NormalMode).url
  ...
  "OnshoreLiabilities Controller" - {
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = UserAnswers(userAnswersId, "session-123").set(OnshoreLiabilitiesPage, true).success.value
