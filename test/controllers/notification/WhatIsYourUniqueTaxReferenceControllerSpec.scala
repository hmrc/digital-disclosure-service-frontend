...
class WhatIsYourUniqueTaxReferenceControllerSpec extends SpecBase with MockitoSugar {
  ...
  "WhatIsYourUniqueTaxReference Controller" - {
    ...
    "must return OK and the correct view for a GET" in {
      ...
      running(application) {
        val request = FakeRequest(GET, whatIsYourUniqueTaxReferenceRoute)

        val result = route(application, request).value

        val view = application.injector.instanceOf[WhatIsYourUniqueTaxReferenceView]
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = UserAnswers(userAnswersId).set(WhatIsYourUniqueTaxReferencePage, "answer").success.value
