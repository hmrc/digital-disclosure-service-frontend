...
class AreYouAMemberOfAnyLandlordAssociationsControllerSpec extends SpecBase with MockitoSugar {
  ...
  "AreYouAMemberOfAnyLandlordAssociations Controller" - {
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = UserAnswers(userAnswersId).set(AreYouAMemberOfAnyLandlordAssociationsPage, true).success.value
