...
import views.html.onshore.IncomeOrGainSourceView
...
class IncomeOrGainSourceControllerSpec extends SpecBase with MockitoSugar {
  ...
  lazy val whereDidTheUndeclaredIncomeOrGainIncludedRoute = onshore.routes.IncomeOrGainSourceController.onPageLoad(NormalMode).url
