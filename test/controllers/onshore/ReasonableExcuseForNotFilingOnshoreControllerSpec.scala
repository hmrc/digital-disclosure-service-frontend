...
import models.{AreYouTheEntity, NormalMode, ReasonableExcuseForNotFilingOnshore, RelatesTo, SubmissionType, UserAnswers}
...
class ReasonableExcuseForNotFilingOnshoreControllerSpec extends SpecBase with MockitoSugar {
  ...
  lazy val whatIsYourReasonableExcuseForNotFilingReturnRoute =
    routes.ReasonableExcuseForNotFilingOnshoreController.onPageLoad(NormalMode).url
