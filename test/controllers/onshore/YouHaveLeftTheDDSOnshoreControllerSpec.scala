...
class YouHaveLeftTheDDSOnshoreControllerSpec extends SpecBase with MockitoSugar {
  ...
  lazy val youHaveLeftTheDDSRoute = onshore.routes.YouHaveLeftTheDDSOnshoreController.onPageLoad(NormalMode).url
  ...
  "YouHaveLeftTheDDSOnshore Controller" - {
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = UserAnswers(userAnswersId).set(YouHaveLeftTheDDSOnshorePage, "answer").success.value
