...
class DoYouHaveACaseReferenceControllerSpec extends SpecBase with MockitoSugar {
  ...
  lazy val doYouHaveACaseReferenceRoute = reference.routes.DoYouHaveACaseReferenceController.onPageLoad(NormalMode).url
  ...
  "DoYouHaveACaseReference Controller" - {
    ...
    "must return OK and the correct view for a GET" in {
      ...
      running(application) {
        ...
        val view = application.injector.instanceOf[DoYouHaveACaseReferenceView]
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = UserAnswers(userAnswersId).set(DoYouHaveACaseReferencePage, true).success.value
