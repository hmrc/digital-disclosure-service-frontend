...
class WhichTelephoneNumberCanWeContactYouWithControllerSpec extends SpecBase with MockitoSugar {
  ...
  "WhichTelephoneNumberCanWeContactYouWith Controller" - {
    ...
    "must return OK and the correct view for a GET" in {
      ...
      contentAsString(result) mustEqual view(form, NormalMode, telephoneNumber)(using request, messages).toString
    }
    ...
    "must return a Bad Request and errors when invalid data is submitted" in {
      ...
      contentAsString(result) mustEqual view(boundForm, NormalMode, telephoneNumber)(using request, messages).toString
    }
