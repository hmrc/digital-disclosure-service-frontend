...
class AdviceProfessionControllerSpec extends SpecBase with MockitoSugar {
  ...
  lazy val adviceProfessionRoute = routes.AdviceProfessionController.onPageLoad(NormalMode).url
  ...
  "AdviceProfession Controller" - {
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = UserAnswers(userAnswersId, "session-123").set(AdviceProfessionPage, "answer").success.value
