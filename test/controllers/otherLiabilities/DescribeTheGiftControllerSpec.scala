...
class DescribeTheGiftControllerSpec extends SpecBase with MockitoSugar {
  ...
  lazy val describeTheGiftRoute = otherLiabilities.routes.DescribeTheGiftController.onPageLoad(NormalMode).url
  ...
  "DescribeTheGift Controller" - {
    ...
    "must return OK and the correct view for a GET" in {
      ...
      running(application) {
        ...
        val view = application.injector.instanceOf[DescribeTheGiftView]
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = UserAnswers(userAnswersId).set(DescribeTheGiftPage, "answer").success.value
