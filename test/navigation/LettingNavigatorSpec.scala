...
import models.{CheckMode, LettingProperty, NoLongerBeingLetOut, NormalMode, TypeOfMortgageDidYouHave, UserAnswers}
import pages._
  ...
  "LettingNavitator" - {
    ...
    "In normal mode" - {
      ...
      "must go from RentalAddressLookupPage to PropertyFirstLetOutController" in {
        ...
        val ua              = UserAnswers(userAnswersId, "session-123").addToSeq(LettingPropertyPage, lettingProperty).success.value

        navigator.nextPage(RentalAddressLookupPage, index, NormalMode, ua) mustBe routes.PropertyFirstLetOutController
      ...
      "must go from PropertyFirstLetOutPage to PropertyStoppedBeingLetOutController" in {
        ...
        navigator.nextPage(
          ...
          NormalMode,
          ua
        ) mustBe routes.PropertyStoppedBeingLetOutController.onPageLoad(index, NormalMode)
      }
      ...
      "must go from PropertyStoppedBeingLetOutPage to PropertyIsNoLongerBeingLetOutController" in {
        ...
        navigator.nextPage(
          ...
          NormalMode,
          ua
        ) mustBe routes.PropertyIsNoLongerBeingLetOutController.onPageLoad(index, NormalMode)
      }
      ...
      "must go from PropertyStoppedBeingLetOutPage to WasPropertyFurnishedController" in {
        ...
        navigator.nextPage(
          ...
          NormalMode,
          ua
        ) mustBe routes.WasPropertyFurnishedController.onPageLoad(index, NormalMode)
      }

      "must go from PropertyIsNoLongerBeingLetOutPage to WasPropertyFurnishedController" in {
        val index           = 0
        val lettingProperty =
          LettingProperty(noLongerBeingLetOut = Some(NoLongerBeingLetOut(LocalDate.now().minusDays(1), "some value")))
        val ua              = UserAnswers(userAnswersId, "session-123").addToSeq(LettingPropertyPage, lettingProperty).success.value
        navigator.nextPage(
      ...
      "must go from WasPropertyFurnishedPage to FHLController" in {
        ...
        val ua              = UserAnswers(userAnswersId, "session-123").addToSeq(LettingPropertyPage, lettingProperty).success.value
        navigator.nextPage(WasPropertyFurnishedPage, index, NormalMode, ua) mustBe routes.FHLController
          .onPageLoad(index, NormalMode)
      }
      ...
      "must go from WasPropertyFurnishedPage to JointlyOwnedPropertyController" in {
        ...
        val ua              = UserAnswers(userAnswersId, "session-123").addToSeq(LettingPropertyPage, lettingProperty).success.value
        navigator.nextPage(WasPropertyFurnishedPage, index, NormalMode, ua) mustBe routes.JointlyOwnedPropertyController
          .onPageLoad(index, NormalMode)
      }
      ...
      "must go from FHLPage to JointlyOwnedPropertyController" in {
        ...
        val ua              = UserAnswers(userAnswersId, "session-123").addToSeq(LettingPropertyPage, lettingProperty).success.value
        navigator.nextPage(FHLPage, index, NormalMode, ua) mustBe routes.JointlyOwnedPropertyController
          .onPageLoad(index, NormalMode)
      }
      ...
      "must go from JointlyOwnedPropertyPage to WhatWasThePercentageIncomeYouReceivedFromPropertyController" in {
        ...
        val ua              = UserAnswers(userAnswersId, "session-123").addToSeq(LettingPropertyPage, lettingProperty).success.value
        navigator.nextPage(
          JointlyOwnedPropertyPage,
          index,
          NormalMode,
          ua
        ) mustBe routes.WhatWasThePercentageIncomeYouReceivedFromPropertyController.onPageLoad(index, NormalMode)
      }
      ...
      "must go from JointlyOwnedPropertyPage to DidYouHaveAMortgageOnPropertyController" in {
        ...
        navigator.nextPage(
          ...
          NormalMode,
          ua
        ) mustBe routes.DidYouHaveAMortgageOnPropertyController.onPageLoad(index, NormalMode)
      }
      ...
      "must go from DidYouHaveAMortgageOnPropertyPage to WhatTypeOfMortgageDidYouHaveController when Yes is selected" in {
        ...
        navigator.nextPage(
          ...
          NormalMode,
          ua
        ) mustBe routes.WhatTypeOfMortgageDidYouHaveController.onPageLoad(index, NormalMode)
      }
      ...
      "must go from DidYouHaveAMortgageOnPropertyPage to WasALettingAgentUsedToManagePropertyController when No is selected" in {
        ...
        navigator.nextPage(
          ...
          NormalMode,
          ua
        ) mustBe routes.WasALettingAgentUsedToManagePropertyController.onPageLoad(index, NormalMode)
      }
      ...
      "must go from WhatTypeOfMortgageDidYouHavePage to WasALettingAgentUsedToManagePropertyController when CapitalRepayment is selected" in {
        ...
        val ua              = UserAnswers(userAnswersId, "session-123").addToSeq(LettingPropertyPage, lettingProperty).success.value
        navigator.nextPage(
          WhatTypeOfMortgageDidYouHavePage,
          index,
          NormalMode,
          ua
        ) mustBe routes.WasALettingAgentUsedToManagePropertyController.onPageLoad(index, NormalMode)
      ...
      "must go from WhatTypeOfMortgageDidYouHavePage to WhatWasTheTypeOfMortgageController when Other is selected" in {
        ...
        navigator.nextPage(
          ...
          NormalMode,
          ua
        ) mustBe routes.WhatWasTheTypeOfMortgageController.onPageLoad(index, NormalMode)
      }
      ...
      "must go from WasALettingAgentUsedToManagePropertyPage to CheckYourAnswersController if selected yes" in {
        ...
        navigator.nextPage(
          ...
          NormalMode,
          ua
        ) mustBe routes.DidTheLettingAgentCollectRentOnYourBehalfController.onPageLoad(index, NormalMode)
      }
      ...
      "must go from WasALettingAgentUsedToManagePropertyPage to CheckYourAnswersController if selected no" in {
        ...
        navigator.nextPage(
          ...
          NormalMode,
          ua
        ) mustBe routes.CheckYourAnswersController.onPageLoad(index, NormalMode)
      }
  ...
  "in Check mode" - {
    ...
    "must go from JointlyOwnedPropertyPage to WhatWasThePercentageIncomeYouReceivedFromPropertyController if answer changed to Yes" in {
      ...
      navigator.nextPage(
        ...
        ua,
        true
      ) mustBe routes.WhatWasThePercentageIncomeYouReceivedFromPropertyController.onPageLoad(index, CheckMode)
    }
    ...
    "must go from JointlyOwnedPropertyPage to CheckYourAnswersController if answer changed to No" in {
      ...
      val lettingProperty = LettingProperty(isJointOwnership = Some(false))
      val ua              = UserAnswers(userAnswersId, "session-123").addToSeq(LettingPropertyPage, lettingProperty).success.value
      navigator.nextPage(JointlyOwnedPropertyPage, index, CheckMode, ua, false) mustBe routes.CheckYourAnswersController
    ...
    "must go from WasPropertyFurnishedPage to FHLController if answer changed to Yes" in {
      ...
      val lettingProperty = LettingProperty(wasFurnished = Some(true))
      val ua              = UserAnswers(userAnswersId, "session-123").addToSeq(LettingPropertyPage, lettingProperty).success.value
      navigator.nextPage(WasPropertyFurnishedPage, index, CheckMode, ua, true) mustBe routes.FHLController
        .onPageLoad(index, CheckMode)
    }
    ...
    "must go from WasPropertyFurnishedPage to CheckYourAnswersController if answer changed to No" in {
      ...
      val lettingProperty = LettingProperty(wasFurnished = Some(false))
      val ua              = UserAnswers(userAnswersId, "session-123").addToSeq(LettingPropertyPage, lettingProperty).success.value
      navigator.nextPage(WasPropertyFurnishedPage, index, CheckMode, ua, false) mustBe routes.CheckYourAnswersController
        .onPageLoad(index, CheckMode)
    }
    ...
    "must go from PropertyStoppedBeingLetOutPage to PropertyIsNoLongerBeingLetOutController if answer changed to Yes" in {
      ...
      navigator.nextPage(
        ...
        ua,
        true
      ) mustBe routes.PropertyIsNoLongerBeingLetOutController.onPageLoad(index, CheckMode)
    }
    ...
    "must go from PropertyStoppedBeingLetOutPage to CheckYourAnswersController if answer changed to No" in {
      ...
      navigator.nextPage(
        ...
        ua,
        false
      ) mustBe routes.CheckYourAnswersController.onPageLoad(index, CheckMode)
    }
    ...
    "must go from DidYouHaveAMortgageOnPropertyPage to WhatTypeOfMortgageDidYouHaveController if answer changed to Yes" in {
      ...
      navigator.nextPage(
        ...
        ua,
        true
      ) mustBe routes.WhatTypeOfMortgageDidYouHaveController.onPageLoad(index, CheckMode)
    }
    ...
    "must go from WhatTypeOfMortgageDidYouHavePage to WhatWasTheTypeOfMortgageController if answer changed to Yes" in {
      ...
      navigator.nextPage(
        ...
        ua,
        true
      ) mustBe routes.WhatWasTheTypeOfMortgageController.onPageLoad(index, CheckMode)
    }
    ...
    "must go from WasALettingAgentUsedToManagePropertyPage to DidTheLettingAgentCollectRentOnYourBehalfController if answer changed to Yes" in {
      ...
      navigator.nextPage(
        ...
        ua,
        true
      ) mustBe routes.DidTheLettingAgentCollectRentOnYourBehalfController.onPageLoad(index, CheckMode)
    }
