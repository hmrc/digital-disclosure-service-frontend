...
class NotificationNavigatorSpec extends SpecBase {
    ...
    "in Normal mode" - {
      ...
      "must go from the ReceivedALetter page to the RelatesTo controller when the user selects No" in {
        UserAnswers("id", "session-123").set(ReceivedALetterPage, false) match {
          case Success(ua) =>
            navigator.nextPage(ReceivedALetterPage, NormalMode, ua) mustBe routes.RelatesToController.onPageLoad(
              NormalMode
            )
      ...
      "must go from the ReceivedALetter page to the LetterReference controller when the user selects Yes" in {
        UserAnswers("id", "session-123").set(ReceivedALetterPage, true) match {
          case Success(ua) =>
            navigator.nextPage(ReceivedALetterPage, NormalMode, ua) mustBe routes.LetterReferenceController.onPageLoad(
              NormalMode
            )
          case Failure(e)  => throw e
        }
      ...
      "must go from the LetterReferencePage page to the RelatesTo controller when the user enter any data" in {
        UserAnswers("id", "session-123").set(LetterReferencePage, "test") match {
          case Success(ua) =>
            navigator.nextPage(LetterReferencePage, NormalMode, ua) mustBe routes.RelatesToController.onPageLoad(
              NormalMode
            )
          case Failure(e)  => throw e
        }
      ...
      "must go from the RelatesTo page to the AreYouTheIndividual controller when select an individual" in {
        UserAnswers("id", "session-123").set(RelatesToPage, RelatesTo.AnIndividual) match {
          case Success(ua) =>
            navigator.nextPage(RelatesToPage, NormalMode, ua) mustBe routes.AreYouTheEntityController.onPageLoad(
              NormalMode
            )
          case Failure(e)  => throw e
        }
      ...
      "must go from the AreYouTheEntity page to the OffshoreLiabilities controller when the user selects Yes" in {
        UserAnswers("id", "session-123").set(AreYouTheEntityPage, AreYouTheEntity.YesIAm) match {
          case Success(ua) =>
            navigator.nextPage(AreYouTheEntityPage, NormalMode, ua) mustBe routes.OffshoreLiabilitiesController
        ...
        UserAnswers("id", "session-123").set(AreYouTheEntityPage, AreYouTheEntity.IAmAnAccountantOrTaxAgent) match {
          case Success(ua) =>
            navigator.nextPage(
              ...
              NormalMode,
              ua
            ) mustBe routes.AreYouRepresentingAnOrganisationController.onPageLoad(NormalMode)
          case Failure(e)  => throw e
        }
      }
      ...
      "must go from the OffshoreLiabilities page to the OnshoreLiabilities controller when the user selects 'I want to disclose offshore liabilities'" in {
        UserAnswers("id", "session-123").set(OffshoreLiabilitiesPage, true) match {
          case Success(ua) =>
            navigator.nextPage(OffshoreLiabilitiesPage, NormalMode, ua) mustBe routes.OnshoreLiabilitiesController
              .onPageLoad(NormalMode)
          case Failure(e)  => throw e
        }
      }
      ...
      "must go from the OffshoreLiabilities page to the OnshoreLiabilities controller when the user selects 'I do not have offshore liabilities to disclose'" in {
        UserAnswers("id", "session-123").set(OffshoreLiabilitiesPage, false) match {
          case Success(ua) =>
            navigator.nextPage(OffshoreLiabilitiesPage, NormalMode, ua) mustBe routes.OnlyOnshoreLiabilitiesController
              .onPageLoad(NormalMode)
          case Failure(e)  => throw e
        }
      }
      ...
      "must go from the OnshoreLiabilitiesPage to the IncomeOrGainSourceController" in {
        navigator.nextPage(
          ...
          NormalMode,
          UserAnswers("id", "session-123")
        ) mustBe routes.IncomeOrGainSourceController.onPageLoad(NormalMode)
      }

      "must go from the OnlyOnshoreLiabilitiesPage to the IncomeOrGainSourceController" in {
        navigator.nextPage(
          OnlyOnshoreLiabilitiesPage,
          NormalMode,
          UserAnswers("id", "session-123")
        ) mustBe routes.IncomeOrGainSourceController.onPageLoad(NormalMode)
      }
      ...
      "must go from the WhatIsYourFullName page to the YourPhoneNumber controller when the user enter name" in {
        ...
        navigator.nextPage(
          ...
          NormalMode,
          ua
        ) mustBe routes.HowWouldYouPreferToBeContactedController.onPageLoad(NormalMode)
      }
      ...
      "must go from the YourEmailAddressPage page to the YourAddressLookupController controller when the user enter an email and on behalf of individual" in {
        ...
        navigator.nextPage(
          ...
          NormalMode,
          userAnswers.success.value
        ) mustBe routes.YourAddressLookupController.lookupAddress(NormalMode)
      }
      ...
      "must go from the WhatIsYourDateOfBirth page to the WhatIsYourMainOccupation controller when the user enter date of birth" in {
        navigator.nextPage(
          ...
          NormalMode,
          UserAnswers("id", "session-123")
        ) mustBe routes.WhatIsYourMainOccupationController.onPageLoad(NormalMode)
      }
      ...
      "must go from the DoYouHaveNationalInsuranceNumber page to the WhatIsYourNationalInsuranceNumber controller when the user selects Yes, and I know my National Insurance number" in {
        UserAnswers("id", "session-123")
          .set(DoYouHaveNationalInsuranceNumberPage, DoYouHaveNationalInsuranceNumber.YesIKnow) match {
          case Success(ua) =>
            navigator.nextPage(
      ...
      "must go from the DoYouHaveNationalInsuranceNumber page to the AreYouRegisteredForVATController when the user selects Yes, but I do not know my National Insurance number" in {
        UserAnswers("id", "session-123")
          .set(DoYouHaveNationalInsuranceNumberPage, DoYouHaveNationalInsuranceNumber.YesButDontKnow) match {
          case Success(ua) =>
            navigator.nextPage(
              DoYouHaveNationalInsuranceNumberPage,
              NormalMode,
              ua
            ) mustBe routes.AreYouRegisteredForVATController.onPageLoad(NormalMode)
          case Failure(e)  => throw e
        }
      }
      ...
      "must go from the DoYouHaveNationalInsuranceNumber page to the AreYouRegisteredForVATController when the user selects No" in {
        UserAnswers("id", "session-123")
          .set(DoYouHaveNationalInsuranceNumberPage, DoYouHaveNationalInsuranceNumber.No) match {
          case Success(ua) =>
            navigator.nextPage(
              DoYouHaveNationalInsuranceNumberPage,
              NormalMode,
        ...
        UserAnswers("id", "session-123").set(WhatIsYourMainOccupationPage, "test") match {
          case Success(ua) =>
            navigator.nextPage(
              ...
              NormalMode,
              ua
            ) mustBe routes.DoYouHaveNationalInsuranceNumberController.onPageLoad(NormalMode)
          case Failure(e)  => throw e
        }
      }
        ...
        UserAnswers("id", "session-123").set(AreYouRegisteredForVATPage, AreYouRegisteredForVAT.YesIKnow) match {
          case Success(ua) =>
            navigator.nextPage(
              ...
              NormalMode,
              ua
            ) mustBe routes.WhatIsYourVATRegistrationNumberController.onPageLoad(NormalMode)
          case Failure(e)  => throw e
        }
      }
        ...
        UserAnswers("id", "session-123").set(AreYouRegisteredForVATPage, AreYouRegisteredForVAT.YesButDontKnow) match {
          case Success(ua) =>
            navigator.nextPage(
              ...
              NormalMode,
              ua
            ) mustBe routes.AreYouRegisteredForSelfAssessmentController.onPageLoad(NormalMode)
          case Failure(e)  => throw e
        }
      }
      ...
      "must go from the AreYouRegisteredForSelfAssessment page to the WhatIsYourUniqueTaxReference controller when the user selects Yes, and I know my UTR" in {
        UserAnswers("id", "session-123")
          .set(AreYouRegisteredForSelfAssessmentPage, AreYouRegisteredForSelfAssessment.YesIKnowMyUTR) match {
          case Success(ua) =>
            navigator.nextPage(
              AreYouRegisteredForSelfAssessmentPage,
              NormalMode,
              ua
            ) mustBe routes.WhatIsYourUniqueTaxReferenceController.onPageLoad(NormalMode)
          case Failure(e)  => throw e
        }
      }
      ...
      "must go from the AreYouRegisteredForSelfAssessment page to the YourAddressLookup controller when the user selects Yes, but I do not know my UTR" in {
        UserAnswers("id", "session-123")
          .set(AreYouRegisteredForSelfAssessmentPage, AreYouRegisteredForSelfAssessment.YesIDontKnowMyUTR) match {
          case Success(ua) =>
            navigator.nextPage(
              AreYouRegisteredForSelfAssessmentPage,
              NormalMode,
      ...
      "must go from the AreYouRegisteredForSelfAssessment page to the YourAddressLookup controller when the user selects No" in {
        UserAnswers("id", "session-123")
          .set(AreYouRegisteredForSelfAssessmentPage, AreYouRegisteredForSelfAssessment.No) match {
          case Success(ua) =>
            navigator.nextPage(
              AreYouRegisteredForSelfAssessmentPage,
              NormalMode,
      ...
      "must go from the WhatIsTheIndividualsFullNamePage to the WhatIsTheIndividualDateOfBirthController" in {
        navigator.nextPage(
          ...
          NormalMode,
          UserAnswers("id", "session-123")
        ) mustBe routes.WhatIsTheIndividualDateOfBirthController.onPageLoad(NormalMode)
      }
      ...
      "must go from the WhatIsTheIndividualOccupationPage to the DoesTheIndividualHaveNationalInsuranceNumberController" in {
        navigator.nextPage(
          ...
          NormalMode,
          UserAnswers("id", "session-123")
        ) mustBe routes.DoesTheIndividualHaveNationalInsuranceNumberController.onPageLoad(NormalMode)
      }
      ...
      "must go from the DoesTheIndividualHaveNationalInsuranceNumberPage to the WhatIsIndividualsNationalInsuranceNumberController when the user selects Yes, and I know their NINO" in {
        UserAnswers("id", "session-123").set(
          DoesTheIndividualHaveNationalInsuranceNumberPage,
          DoesTheIndividualHaveNationalInsuranceNumber.YesIKnow
        ) match {
          case Success(ua) =>
            navigator.nextPage(
              DoesTheIndividualHaveNationalInsuranceNumberPage,
              NormalMode,
              ua
            ) mustBe routes.WhatIsIndividualsNationalInsuranceNumberController.onPageLoad(NormalMode)
          case Failure(e)  => throw e
        }
      }
      ...
      "must go from the DoesTheIndividualHaveNationalInsuranceNumberPage to the YourAddressLookup controller when the user selects Yes, but I do not know their UTR" in {
        UserAnswers("id", "session-123").set(
          DoesTheIndividualHaveNationalInsuranceNumberPage,
          DoesTheIndividualHaveNationalInsuranceNumber.YesButDontKnow
        ) match {
          case Success(ua) =>
            navigator.nextPage(
              DoesTheIndividualHaveNationalInsuranceNumberPage,
              NormalMode,
              ua
            ) mustBe routes.IsTheIndividualRegisteredForVATController.onPageLoad(NormalMode)
          case Failure(e)  => throw e
        }
      }
      ...
      "must go from the DoesTheIndividualHaveNationalInsuranceNumberPage to the YourAddressLookup controller when the user selects No" in {
        UserAnswers("id", "session-123").set(
          DoesTheIndividualHaveNationalInsuranceNumberPage,
          DoesTheIndividualHaveNationalInsuranceNumber.No
        ) match {
          case Success(ua) =>
            navigator.nextPage(
              DoesTheIndividualHaveNationalInsuranceNumberPage,
      ...
      "must go from the WhatIsTheIndividualDateOfBirthPage to the WhatIsTheIndividualOccupationController" in {
        navigator.nextPage(
          ...
          NormalMode,
          UserAnswers("id", "session-123")
        ) mustBe routes.WhatIsTheIndividualOccupationController.onPageLoad(NormalMode)
      }
      ...
      "must go from the IsTheIndividualRegisteredForVATPage to the WhatIsIndividualsNationalInsuranceNumberController when the user selects Yes, and I know their VAT registration number" in {
        UserAnswers("id", "session-123")
          .set(IsTheIndividualRegisteredForVATPage, IsTheIndividualRegisteredForVAT.YesIKnow) match {
          case Success(ua) =>
            navigator.nextPage(
              IsTheIndividualRegisteredForVATPage,
              NormalMode,
              ua
            ) mustBe routes.WhatIsTheIndividualsVATRegistrationNumberController.onPageLoad(NormalMode)
          case Failure(e)  => throw e
        }
      }
      ...
      "must go from the IsTheIndividualRegisteredForVATPage to the IsTheIndividualRegisteredForSelfAssessmentController when the user selects Yes, but I do not know their VAT registration number" in {
        UserAnswers("id", "session-123")
          .set(IsTheIndividualRegisteredForVATPage, IsTheIndividualRegisteredForVAT.YesButDontKnow) match {
          case Success(ua) =>
            navigator.nextPage(
              IsTheIndividualRegisteredForVATPage,
              NormalMode,
              ua
            ) mustBe routes.IsTheIndividualRegisteredForSelfAssessmentController.onPageLoad(NormalMode)
          case Failure(e)  => throw e
        }
      }
      ...
      "must go from the IsTheIndividualRegisteredForVATPage to the IsTheIndividualRegisteredForSelfAssessmentController when the user selects No" in {
        UserAnswers("id", "session-123")
          .set(IsTheIndividualRegisteredForVATPage, IsTheIndividualRegisteredForVAT.No) match {
          case Success(ua) =>
            navigator.nextPage(
              IsTheIndividualRegisteredForVATPage,
              NormalMode,
      ...
      "must go from the WhatIsTheIndividualsUniqueTaxReferencePage to the IndividualAddressLookupController" in {
        navigator.nextPage(
          ...
          NormalMode,
          UserAnswers("id", "session-123")
        ) mustBe routes.IndividualAddressLookupController.lookupAddress(NormalMode)
      }
      ...
      "must go from the IsTheIndividualRegisteredForSelfAssessmentPage to the WhatIsTheIndividualsUniqueTaxReferenceController when the user selects Yes, and I know their UTR number" in {
        UserAnswers("id", "session-123").set(
          ...
          IsTheIndividualRegisteredForSelfAssessment.YesIKnow
        ) match {
          case Success(ua) =>
            navigator.nextPage(
              IsTheIndividualRegisteredForSelfAssessmentPage,
              NormalMode,
              ua
            ) mustBe routes.WhatIsTheIndividualsUniqueTaxReferenceController.onPageLoad(NormalMode)
          case Failure(e)  => throw e
        }
      }
      ...
      "must go from the IsTheIndividualRegisteredForSelfAssessmentPage to the IndividualAddressLookupController when the user selects Yes, but I do not know their UTR number" in {
        UserAnswers("id", "session-123").set(
          IsTheIndividualRegisteredForSelfAssessmentPage,
          IsTheIndividualRegisteredForSelfAssessment.YesButDontKnow
        ) match {
          case Success(ua) =>
            navigator.nextPage(
              IsTheIndividualRegisteredForSelfAssessmentPage,
      ...
      "must go from the IsTheIndividualRegisteredForSelfAssessmentPage to the IndividualAddressLookupController when the user selects No" in {
        UserAnswers("id", "session-123")
          .set(IsTheIndividualRegisteredForSelfAssessmentPage, IsTheIndividualRegisteredForSelfAssessment.No) match {
          case Success(ua) =>
            navigator.nextPage(
              IsTheIndividualRegisteredForSelfAssessmentPage,
              NormalMode,
      ...
      "must go from the IndividualAddressLookupPage to the WhatIsYourFullNameController" in {
        navigator.nextPage(
          ...
          NormalMode,
          UserAnswers("id", "session-123")
        ) mustBe routes.WhatIsYourFullNameController.onPageLoad(NormalMode)
      }
        ...
        UserAnswers("id", "session-123").set(AreYouRepresentingAnOrganisationPage, true) match {
          case Success(ua) =>
            navigator.nextPage(
              ...
              NormalMode,
              ua
            ) mustBe routes.WhatIsTheNameOfTheOrganisationYouRepresentController.onPageLoad(NormalMode)
          case Failure(e)  => throw e
        }
      }
        ...
        UserAnswers("id", "session-123").set(AreYouRepresentingAnOrganisationPage, false) match {
          case Success(ua) =>
            navigator.nextPage(
              ...
              NormalMode,
              ua
            ) mustBe routes.OffshoreLiabilitiesController.onPageLoad(NormalMode)
          case Failure(e)  => throw e
        }
      }
      ...
      "must go from the WhatIsTheNameOfTheCompanyTheDisclosureWillBeAboutPage to the WhatIsTheCompanyRegistrationNumberController when the user enter company name" in {
        navigator.nextPage(
          ...
          NormalMode,
          UserAnswers("id", "session-123")
        ) mustBe routes.WhatIsTheCompanyRegistrationNumberController.onPageLoad(NormalMode)
      }
      ...
      "must go from the WhatIsTheCompanyRegistrationNumberPage to the CompanyAddressLookupController" in {
        navigator.nextPage(
          ...
          NormalMode,
          UserAnswers("id", "session-123")
        ) mustBe routes.CompanyAddressLookupController.lookupAddress(NormalMode)
      }
      ...
      "must go from the WhatIsTheLLPNamePage to the LLPAddressLookupController when the user enter llp name" in {
        navigator.nextPage(
          ...
          NormalMode,
          UserAnswers("id", "session-123")
        ) mustBe routes.LLPAddressLookupController.lookupAddress(NormalMode)
      }
      ...
      "must go from the WhatIsTheTrustNamePage to the TrustAddressLookupController when the user enter trust name" in {
        navigator.nextPage(
          ...
          NormalMode,
          UserAnswers("id", "session-123")
        ) mustBe routes.TrustAddressLookupController.lookupAddress(NormalMode)
      }
      ...
      "must go from the WhatWasTheNameOfThePersonWhoDiedPage to the WhatWasThePersonDateOfBirthController when the user enter a valid name" in {
        navigator.nextPage(
          ...
          NormalMode,
          UserAnswers("id", "session-123")
        ) mustBe routes.WhatWasThePersonDateOfBirthController.onPageLoad(NormalMode)
      }
      ...
      "must go from the WhatWasThePersonDateOfBirthPage to the WhatWasThePersonOccupationController when the user enter a valid name" in {
        navigator.nextPage(
          ...
          NormalMode,
          UserAnswers("id", "session-123")
        ) mustBe routes.WhatWasThePersonOccupationController.onPageLoad(NormalMode)
      }
      ...
      "must go from the WhatWasThePersonOccupationPage to the DidThePersonHaveNINOController when the user enter a valid name" in {
        navigator.nextPage(
          ...
          NormalMode,
          UserAnswers("id", "session-123")
        ) mustBe routes.DidThePersonHaveNINOController.onPageLoad(NormalMode)
      }
      ...
      "must go from the DidThePersonHaveNINOPage to the WhatWasThePersonNINOController when the user selects Yes, and I know their NINO" in {
        UserAnswers("id", "session-123").set(DidThePersonHaveNINOPage, DidThePersonHaveNINO.YesIKnow) match {
          case Success(ua) =>
            navigator.nextPage(DidThePersonHaveNINOPage, NormalMode, ua) mustBe routes.WhatWasThePersonNINOController
              .onPageLoad(NormalMode)
          case Failure(e)  => throw e
        }
      }
        ...
        UserAnswers("id", "session-123").set(DidThePersonHaveNINOPage, DidThePersonHaveNINO.YesButDontKnow) match {
          case Success(ua) =>
            navigator.nextPage(
              ...
              NormalMode,
              ua
            ) mustBe routes.WasThePersonRegisteredForVATController.onPageLoad(NormalMode)
          case Failure(e)  => throw e
        }
      }
      ...
      "must go from the WasThePersonRegisteredForVATPage to the WhatWasThePersonVATRegistrationNumberController when the user selects Yes, and I know their VAT" in {
        UserAnswers("id", "session-123")
          .set(WasThePersonRegisteredForVATPage, WasThePersonRegisteredForVAT.YesIKnow) match {
          case Success(ua) =>
            navigator.nextPage(
              WasThePersonRegisteredForVATPage,
              NormalMode,
              ua
            ) mustBe routes.WhatWasThePersonVATRegistrationNumberController.onPageLoad(NormalMode)
          case Failure(e)  => throw e
        }
      }
      ...
      "must go from the WasThePersonRegisteredForVATPage to the WasThePersonRegisteredForSAController when the user selects Yes, but I do not know their VAT" in {
        UserAnswers("id", "session-123")
          .set(WasThePersonRegisteredForVATPage, WasThePersonRegisteredForVAT.YesButIDontKnow) match {
          case Success(ua) =>
            navigator.nextPage(
              WasThePersonRegisteredForVATPage,
              NormalMode,
              ua
            ) mustBe routes.WasThePersonRegisteredForSAController.onPageLoad(NormalMode)
          case Failure(e)  => throw e
        }
      }
      ...
      "must go from the WasThePersonRegisteredForSAPage to the WhatWasThePersonUTRController when the user selects Yes, and I know their UTR" in {
        UserAnswers("id", "session-123")
          .set(WasThePersonRegisteredForSAPage, WasThePersonRegisteredForSA.YesIKnow) match {
          case Success(ua) =>
            navigator.nextPage(
              WasThePersonRegisteredForSAPage,
              NormalMode,
              ua
            ) mustBe routes.WhatWasThePersonUTRController.onPageLoad(NormalMode)
          case Failure(e)  => throw e
        }
      }
      ...
      "must go from the WasThePersonRegisteredForSAPage to the EstateAddressLookupController when the user selects Yes, but I do not know their UTR" in {
        UserAnswers("id", "session-123")
          .set(WasThePersonRegisteredForSAPage, WasThePersonRegisteredForSA.YesButIDontKnow) match {
          case Success(ua) =>
            navigator.nextPage(
              WasThePersonRegisteredForSAPage,
              NormalMode,
              ua
            ) mustBe routes.EstateAddressLookupController.lookupAddress(NormalMode)
          case Failure(e)  => throw e
        }
      }
      ...
      "must go from the HowWouldYouPreferToBeContactedPage to the YourEmailAddressController when the user selects only Email as preferred method" in {
        ...
        navigator.nextPage(HowWouldYouPreferToBeContactedPage, NormalMode, ua) mustBe routes.YourEmailAddressController
          .onPageLoad(NormalMode)
      }
      ...
      "must go from the HowWouldYouPreferToBeContactedPage to the YourPhoneNumberController when the user selects only Telephone as preferred method" in {
        ...
        val ua                                          = UserAnswers("id", "session-123").set(HowWouldYouPreferToBeContactedPage, answer).success.value
        navigator.nextPage(HowWouldYouPreferToBeContactedPage, NormalMode, ua) mustBe routes.YourPhoneNumberController
          .onPageLoad(NormalMode)
      }
      ...
      "must go from the HowWouldYouPreferToBeContactedPage to the YourEmailAddressController when the user selects Email and Telephone as preferred method" in {
        val answer: Set[HowWouldYouPreferToBeContacted] =
      ...
      "must go from IncomeOrGainSourcePage to OtherIncomeOrGainSourceController when the user has selected SomewhereElse" in {
        ...
        navigator.nextPage(
          ...
          NormalMode,
          userAnswers
        ) mustBe routes.OtherIncomeOrGainSourceController.onPageLoad(NormalMode)
      }
      ...
      "must go from IncomeOrGainSourcePage to OtherIncomeOrGainSourceController when the user has selected a combination of SomewhereElse with other answers" in {
        val set: Set[IncomeOrGainSource] = Set(
          IncomeOrGainSource.SomewhereElse,
          IncomeOrGainSource.PropertyIncome,
          IncomeOrGainSource.SelfEmploymentIncome
        )
        val userAnswers                  = UserAnswers("id", "session-123").set(IncomeOrGainSourcePage, set).success.value
        navigator.nextPage(
          IncomeOrGainSourcePage,
    ...
    "in Check mode" - {
      ...
      "must go from the AreYouRegisteredForVATPage to WhatIsYourVATRegistrationNumberController where the answer is YesIKnow and has changed" in {
        val userAnswers = UserAnswers("id", "session-123")
          .set(AreYouRegisteredForVATPage, AreYouRegisteredForVAT.YesIKnow)
          .success
          .value
        navigator.nextPage(
          AreYouRegisteredForVATPage,
          ...
          userAnswers,
          true
        ) mustBe routes.WhatIsYourVATRegistrationNumberController.onPageLoad(CheckMode)
      }

      "must go from the AreYouRegisteredForVATPage to CheckYourAnswers where the answer is No and has changed" in {
        val userAnswers =
          UserAnswers("id", "session-123").set(AreYouRegisteredForVATPage, AreYouRegisteredForVAT.No).success.value
        navigator.nextPage(
          AreYouRegisteredForVATPage,
          CheckMode,
          userAnswers,
      ...
      "must go from the AreYouRegisteredForVATPage to CheckYourAnswers where the answer is YesButDontKnow and has changed" in {
        val userAnswers = UserAnswers("id", "session-123")
          .set(AreYouRegisteredForVATPage, AreYouRegisteredForVAT.YesButDontKnow)
          .success
          .value
        navigator.nextPage(
          AreYouRegisteredForVATPage,
      ...
      "must go from the AreYouRegisteredForSelfAssessmentPage to WhatIsYourUniqueTaxReferenceController where the answer is YesIKnowMyUTR and has changed" in {
        val userAnswers = UserAnswers("id", "session-123")
          .set(AreYouRegisteredForSelfAssessmentPage, AreYouRegisteredForSelfAssessment.YesIKnowMyUTR)
          .success
          .value
        navigator.nextPage(
          AreYouRegisteredForSelfAssessmentPage,
          ...
          userAnswers,
          true
        ) mustBe routes.WhatIsYourUniqueTaxReferenceController.onPageLoad(CheckMode)
      }

      "must go from the AreYouRegisteredForSelfAssessmentPage to CheckYourAnswers where the answer is No and has changed" in {
        val userAnswers = UserAnswers("id", "session-123")
          .set(AreYouRegisteredForSelfAssessmentPage, AreYouRegisteredForSelfAssessment.No)
          .success
          .value
        navigator.nextPage(
          AreYouRegisteredForSelfAssessmentPage,
      ...
      "must go from the AreYouRegisteredForSelfAssessmentPage to CheckYourAnswers where the answer is YesIDontKnowMyUTR and has changed" in {
        val userAnswers = UserAnswers("id", "session-123")
          .set(AreYouRegisteredForSelfAssessmentPage, AreYouRegisteredForSelfAssessment.YesIDontKnowMyUTR)
          .success
          .value
        navigator.nextPage(
          AreYouRegisteredForSelfAssessmentPage,
      ...
      "must go from the IsTheIndividualRegisteredForVATPage to WhatIsTheIndividualsVATRegistrationNumberPage where the answer is YesIKnow and has changed" in {
        val userAnswers = UserAnswers("id", "session-123")
          .set(IsTheIndividualRegisteredForVATPage, IsTheIndividualRegisteredForVAT.YesIKnow)
          .success
          .value
        navigator.nextPage(
          IsTheIndividualRegisteredForVATPage,
          ...
          userAnswers,
          true
        ) mustBe routes.WhatIsTheIndividualsVATRegistrationNumberController.onPageLoad(CheckMode)
      }

      "must go from the IsTheIndividualRegisteredForVATPage to CheckYourAnswers where the answer is No and has changed" in {
        val userAnswers = UserAnswers("id", "session-123")
          .set(IsTheIndividualRegisteredForVATPage, IsTheIndividualRegisteredForVAT.No)
          .success
          .value
        navigator.nextPage(
          IsTheIndividualRegisteredForVATPage,
      ...
      "must go from the IsTheIndividualRegisteredForVATPage to CheckYourAnswers where the answer is YesButDontKnow and has changed" in {
        val userAnswers = UserAnswers("id", "session-123")
          .set(IsTheIndividualRegisteredForVATPage, IsTheIndividualRegisteredForVAT.YesButDontKnow)
          .success
          .value
        navigator.nextPage(
          IsTheIndividualRegisteredForVATPage,
      ...
      "must go from the IsTheIndividualRegisteredForSelfAssessmentPage to WhatIsTheIndividualsVATRegistrationNumberPage where the answer is YesIKnow and has changed" in {
        val userAnswers = UserAnswers("id", "session-123")
          .set(IsTheIndividualRegisteredForSelfAssessmentPage, IsTheIndividualRegisteredForSelfAssessment.YesIKnow)
          .success
          .value
        navigator.nextPage(
          IsTheIndividualRegisteredForSelfAssessmentPage,
          ...
          userAnswers,
          true
        ) mustBe routes.WhatIsTheIndividualsUniqueTaxReferenceController.onPageLoad(CheckMode)
      }
      ...
      "must go from the IsTheIndividualRegisteredForSelfAssessmentPage to CheckYourAnswers where the answer is No and has changed" in {
        val userAnswers = UserAnswers("id", "session-123")
          .set(IsTheIndividualRegisteredForSelfAssessmentPage, IsTheIndividualRegisteredForSelfAssessment.No)
          .success
          .value
        navigator.nextPage(
          IsTheIndividualRegisteredForSelfAssessmentPage,
      ...
      "must go from the DoesTheIndividualHaveNationalInsuranceNumberPage to WhatIsIndividualsNationalInsuranceNumberPage where the answer is YesIKnow and has changed" in {
        val userAnswers = UserAnswers("id", "session-123")
          .set(DoesTheIndividualHaveNationalInsuranceNumberPage, DoesTheIndividualHaveNationalInsuranceNumber.YesIKnow)
          .success
          .value
        navigator.nextPage(
          DoesTheIndividualHaveNationalInsuranceNumberPage,
          ...
          userAnswers,
          true
        ) mustBe routes.WhatIsIndividualsNationalInsuranceNumberController.onPageLoad(CheckMode)
      }
      ...
      "must go from the DoesTheIndividualHaveNationalInsuranceNumberPage to CheckYourAnswers where the answer is No and has changed" in {
        val userAnswers = UserAnswers("id", "session-123")
          .set(DoesTheIndividualHaveNationalInsuranceNumberPage, DoesTheIndividualHaveNationalInsuranceNumber.No)
          .success
          .value
        navigator.nextPage(
          DoesTheIndividualHaveNationalInsuranceNumberPage,
      ...
      "must go from the AreYouTheEntityPage to CheckYourAnswers where the answer is Yes and has not changed" in {
        val userAnswers =
          UserAnswers("id", "session-123").set(AreYouTheEntityPage, AreYouTheEntity.YesIAm).success.value
        navigator.nextPage(
          AreYouTheEntityPage,
          CheckMode,
          userAnswers,
      ...
      "must go from the AreYouTheEntityPage to AreYouRepresentingAnOrganisationController where the answer is Yes and has changed to No (non individual)" in {
        val userAnswers = (for {
          initialUa <-
            UserAnswers("id", "session-123").set(AreYouTheEntityPage, AreYouTheEntity.IAmAnAccountantOrTaxAgent)
        ...
        navigator.nextPage(
          ...
          userAnswers,
          true
        ) mustBe routes.AreYouRepresentingAnOrganisationController.onPageLoad(CheckMode)
      }
      ...
      "must go from the AreYouRepresentingAnOrganisationPage to WhatIsTheNameOfTheOrganisationYouRepresentController where the answer is Yes" in {
        ...
        navigator.nextPage(
          ...
          userAnswers,
          true
        ) mustBe routes.WhatIsTheNameOfTheOrganisationYouRepresentController.onPageLoad(CheckMode)
      }

      "must go from the AreYouRepresentingAnOrganisationPage to CheckYourAnswers where the answer is No" in {
        val userAnswers =
          UserAnswers("id", "session-123").set(AreYouRepresentingAnOrganisationPage, false).success.value
        navigator.nextPage(
          AreYouRepresentingAnOrganisationPage,
          CheckMode,
          userAnswers,
      ...
      "must go from the DidThePersonHaveNINOPage to WhatIsIndividualsNationalInsuranceNumberPage where the answer is YesIKnow and has changed" in {
        val userAnswers =
          UserAnswers("id", "session-123").set(DidThePersonHaveNINOPage, DidThePersonHaveNINO.YesIKnow).success.value
        navigator.nextPage(
          DidThePersonHaveNINOPage,
          CheckMode,
          userAnswers,
          true
        ) mustBe routes.WhatWasThePersonNINOController.onPageLoad(CheckMode)
      }

      "must go from the DidThePersonHaveNINOPage to CheckYourAnswers where the answer is No and has changed" in {
        val userAnswers =
          UserAnswers("id", "session-123").set(DidThePersonHaveNINOPage, DidThePersonHaveNINO.No).success.value
        navigator.nextPage(
          DidThePersonHaveNINOPage,
          CheckMode,
          userAnswers,
      ...
      "must go from the DidThePersonHaveNINOPage to CheckYourAnswers where the answer is YesButDontKnow and has changed" in {
        val userAnswers = UserAnswers("id", "session-123")
          .set(DidThePersonHaveNINOPage, DidThePersonHaveNINO.YesButDontKnow)
          .success
          .value
        navigator.nextPage(
          DidThePersonHaveNINOPage,
      ...
      "must go from the WasThePersonRegisteredForSAPage to WhatWasThePersonUTRC page where the answer is YesIKnow and has changed" in {
        val userAnswers = UserAnswers("id", "session-123")
          .set(WasThePersonRegisteredForSAPage, WasThePersonRegisteredForSA.YesIKnow)
          .success
          .value
        navigator.nextPage(
          WasThePersonRegisteredForSAPage,
          ...
          userAnswers,
          true
        ) mustBe routes.WhatWasThePersonUTRController.onPageLoad(CheckMode)
      }
      "must go from the WasThePersonRegisteredForSAPage to CheckYourAnswers where the answer is No and has changed" in {
        val userAnswers = UserAnswers("id", "session-123")
          .set(WasThePersonRegisteredForSAPage, WasThePersonRegisteredForSA.No)
          .success
          .value
        navigator.nextPage(
          WasThePersonRegisteredForSAPage,
      ...
      "must go from the WasThePersonRegisteredForSAPage to CheckYourAnswers where the answer is YesButDontKnow and has changed" in {
        val userAnswers = UserAnswers("id", "session-123")
          .set(WasThePersonRegisteredForSAPage, WasThePersonRegisteredForSA.YesButIDontKnow)
          .success
          .value
        navigator.nextPage(
          WasThePersonRegisteredForSAPage,
      ...
      "must go from the WasThePersonRegisteredForVATPage to WhatWasThePersonVATRegistrationNumber page where the answer is YesIKnow and has changed" in {
        val userAnswers = UserAnswers("id", "session-123")
          .set(WasThePersonRegisteredForVATPage, WasThePersonRegisteredForVAT.YesIKnow)
          .success
          .value
        navigator.nextPage(
          WasThePersonRegisteredForVATPage,
          ...
          userAnswers,
          true
        ) mustBe routes.WhatWasThePersonVATRegistrationNumberController.onPageLoad(CheckMode)
      }
      "must go from the WasThePersonRegisteredForVATPage to CheckYourAnswers where the answer is No and has changed" in {
        val userAnswers = UserAnswers("id", "session-123")
          .set(WasThePersonRegisteredForVATPage, WasThePersonRegisteredForVAT.No)
          .success
          .value
        navigator.nextPage(
          WasThePersonRegisteredForVATPage,
      ...
      "must go from the WasThePersonRegisteredForVATPage to CheckYourAnswers where the answer is YesButDontKnow and has changed" in {
        val userAnswers = UserAnswers("id", "session-123")
          .set(WasThePersonRegisteredForVATPage, WasThePersonRegisteredForVAT.YesButIDontKnow)
          .success
          .value
        navigator.nextPage(
          WasThePersonRegisteredForVATPage,
      ...
      "must go from the HowWouldYouPreferToBeContactedPage to YourEmailAddress page when the contact preference answer has changed and Email is selected and it's not already set" in {
        ...
        navigator.nextPage(
          ...
          CheckMode,
          userAnswers
        ) mustBe routes.YourEmailAddressController.onPageLoad(CheckMode)
      }
      ...
      "must go from the HowWouldYouPreferToBeContactedPage to YourPhone page when the contact preference answer has changed, Telephone is selected and it's not already set" in {
        ...
        navigator.nextPage(
          ...
          CheckMode,
          userAnswers
        ) mustBe routes.YourPhoneNumberController.onPageLoad(CheckMode)
      }
      ...
      "must go from the YourEmailAddressPage to YourPhone page when the contact preference answers contains the Telephone and it's not already set" in {
        val answer: Set[HowWouldYouPreferToBeContacted] = Set(HowWouldYouPreferToBeContacted.Telephone)
        val userAnswers                                 = UserAnswers("id", "session-123").set(HowWouldYouPreferToBeContactedPage, answer).success.value
        navigator.nextPage(YourEmailAddressPage, CheckMode, userAnswers) mustBe routes.YourPhoneNumberController
  ...
  def testAboutSectionRouting(page: Page) = {
    s"must go from $page to the WhatIsYourFullName page when the user is the individual" in {
      ...
      navigator.nextPage(page, NormalMode, userAnswers.success.value) mustBe routes.WhatIsYourFullNameController
        .onPageLoad(NormalMode)
    }
    ...
    s"must go from $page to the WhatIsTheIndividualsFullName page when the user is the individual and disclosing on behalf of the individual" in {
      ...
      navigator.nextPage(
        ...
        NormalMode,
        userAnswers.success.value
      ) mustBe routes.WhatIsTheIndividualsFullNameController.onPageLoad(NormalMode)
    }
    ...
    s"must go from $page to the WhatIsTheNameOfTheCompanyTheDisclosureWillBeAbout page when the user is a company" in {
      ...
      navigator.nextPage(
        ...
        NormalMode,
        userAnswers.success.value
      ) mustBe routes.WhatIsTheNameOfTheCompanyTheDisclosureWillBeAboutController.onPageLoad(NormalMode)
    }
    ...
    s"must go from $page to the WhatIsTheLLPName page when the user is a company" in {
      ...
      navigator.nextPage(page, NormalMode, userAnswers.success.value) mustBe routes.WhatIsTheLLPNameController
        .onPageLoad(NormalMode)
    }
    ...
    s"must go from $page to the WhatIsTheTrustName page when the user is a company" in {
      ...
      navigator.nextPage(page, NormalMode, userAnswers.success.value) mustBe routes.WhatIsTheTrustNameController
        .onPageLoad(NormalMode)
    }
    ...
    s"must go from $page to the WhatWasTheNameOfThePersonWhoDied page when the user is a company" in {
      ...
      navigator.nextPage(
        ...
        NormalMode,
        userAnswers.success.value
      ) mustBe routes.WhatWasTheNameOfThePersonWhoDiedController.onPageLoad(NormalMode)
    }
  }
