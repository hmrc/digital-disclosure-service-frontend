...
class DoesTheIndividualHaveNationalInsuranceNumberFormProviderSpec extends OptionFieldBehaviours {
  ...
  ".value" - {
    ...
    val fieldName = "value"
    val requiredKey = "doesTheIndividualHaveNationalInsuranceNumber.error.required"
