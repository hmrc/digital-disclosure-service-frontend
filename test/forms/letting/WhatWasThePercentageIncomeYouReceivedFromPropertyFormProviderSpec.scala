...
class WhatWasThePercentageIncomeYouReceivedFromPropertyFormProviderSpec extends IntFieldBehaviours {
  ...
  ".value" - {
    ...
    behave like mandatoryField(
      form,
      fieldName,
      requiredError = FormError(fieldName, "whatWasThePercentageIncomeYouReceivedFromProperty.error.required")
    )
  }
}
