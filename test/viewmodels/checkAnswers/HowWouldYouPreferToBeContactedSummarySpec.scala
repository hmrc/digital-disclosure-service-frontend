...
import models.{HowWouldYouPreferToBeContacted, UserAnswers}
import pages.HowWouldYouPreferToBeContactedPage
import play.api.i18n.Messages

class HowWouldYouPreferToBeContactedSummarySpec extends SpecBase {

  implicit val mess: Messages = messages

  "HowWouldYouPreferToBeContactedSummary" - {

    "must return None when the page has no answer" in {
      val userAnswers = UserAnswers("id", "session-123")
      HowWouldYouPreferToBeContactedSummary.row(userAnswers) mustBe None
    }
