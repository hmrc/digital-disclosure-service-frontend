...
class FullDisclosureSpec extends AnyFreeSpec with Matchers with OptionValues {
  ...
  "isComplete" - {
    ...
    "must return true where they are an individual and all sections are complete" in {
      val fullDisclosure = FullDisclosure("userId", "disclosureId", instant, Metadata(), completedIndPersonalDetails, completedOfffshoreLiabilities, completedIndOtherLiabilities, completedReasonForDisclosingNow)
      fullDisclosure.isComplete mustBe true
    }

    "must return true where they are not an individual and all sections are complete" in {
      val fullDisclosure = FullDisclosure("userId", "disclosureId", instant, Metadata(), completedLLPPersonalDetails, completedOfffshoreLiabilities, completedLLPOtherLiabilities, completedReasonForDisclosingNow)
      fullDisclosure.isComplete mustBe true
    }

    "must return false where the ReasonForDisclosingNow section is not complete" in {
      val fullDisclosure = FullDisclosure("userId", "disclosureId", instant, Metadata(), completedLLPPersonalDetails, completedOfffshoreLiabilities, completedLLPOtherLiabilities, ReasonForDisclosingNow())
      fullDisclosure.isComplete mustBe false
    }

    "must return false where the OffshoreLiabilities section is not complete" in {
      val fullDisclosure = FullDisclosure("userId", "disclosureId", instant, Metadata(), completedLLPPersonalDetails, OffshoreLiabilities(), completedLLPOtherLiabilities, completedReasonForDisclosingNow)
      fullDisclosure.isComplete mustBe false
    }

    "must return false where the user is an individual and other liabilities isn't complete for an individual" in {
      val fullDisclosure = FullDisclosure("userId", "disclosureId", instant, Metadata(), completedIndPersonalDetails, completedOfffshoreLiabilities, completedLLPOtherLiabilities, completedReasonForDisclosingNow)
      fullDisclosure.isComplete mustBe false
    }

    "must return false where the personal details section is not complete" in {
      val fullDisclosure = FullDisclosure("userId", "disclosureId", instant, Metadata(), PersonalDetails(Background(), AboutYou()), completedOfffshoreLiabilities, completedIndOtherLiabilities, completedReasonForDisclosingNow)
      fullDisclosure.isComplete mustBe false
    }

    "must return false where the OtherLiabilities section is not complete" in {
      val fullDisclosure = FullDisclosure("userId", "disclosureId", instant, Metadata(), completedIndPersonalDetails, completedOfffshoreLiabilities, OtherLiabilities(), completedReasonForDisclosingNow)
      fullDisclosure.isComplete mustBe false
    }

    "must return false where they have not answered all necessary questions" in {
      val fullDisclosure = FullDisclosure("userId", "disclosureId", instant, Metadata(), PersonalDetails(Background(), AboutYou()), OffshoreLiabilities(), OtherLiabilities(), ReasonForDisclosingNow())
      fullDisclosure.isComplete mustBe false
    }
