...
class NotificationSpec extends AnyFreeSpec with Matchers with OptionValues {
  ...
  "isComplete" - {
    ...
    "must return true where you are the individual and all questions are answered" in {
      val completedBackground = Background(Some(false), None, Some(DisclosureEntity(Individual, Some(true))), Some(false), None, Some(true), Some(false), Some(Set(IncomeOrGainSource.Dividends)))
    ...
    "must return true where you are NOT the individual and all questions are answered" in {
      val completedBackground = Background(Some(false), None, Some(DisclosureEntity(Individual, Some(false))), Some(false), None, Some(true), Some(false), Some(Set(IncomeOrGainSource.Dividends)))
    ...
    "must return true where they are an estate and all questions are answered" in {
      val completedBackground = Background(Some(false), None, Some(DisclosureEntity(Estate, Some(true))), Some(false), None, Some(true), Some(false), Some(Set(IncomeOrGainSource.Dividends)))
      val aboutYou = AboutYou(Some("name"), None, Some("email"), None, None, Some(ContactPreferences(Set(Email))), None, None, None, None, None, None, Some(address))
    ...
    "must return true where they are a company and all questions are answered" in {
      val completedBackground = Background(Some(false), None, Some(DisclosureEntity(Company, Some(true))), Some(false), None, Some(true), Some(false), Some(Set(IncomeOrGainSource.Dividends)))
      val aboutYou = AboutYou(Some("name"), None, Some("email"), None, None, Some(ContactPreferences(Set(Email))), None, None, None, None, None, None, Some(address))
    ...
    "must return true where they are a trust and all questions are answered" in {
      val completedBackground = Background(Some(false), None, Some(DisclosureEntity(Trust, Some(true))), Some(false), None, Some(true), Some(false), Some(Set(IncomeOrGainSource.Dividends)))
      val aboutYou = AboutYou(Some("name"), None, Some("email"), None, None, Some(ContactPreferences(Set(Email))), None, None, None, None, None, None, Some(address))
    ...
    "must return true where they are a LLP and all questions are answered" in {
      val completedBackground = Background(Some(false), None, Some(DisclosureEntity(LLP, Some(true))), Some(false), None, Some(true), Some(false), Some(Set(IncomeOrGainSource.Dividends)))
      val aboutYou = AboutYou(Some("name"), None, Some("email"), None, None, Some(ContactPreferences(Set(Email))), None, None, None, None, None, None, Some(address))
