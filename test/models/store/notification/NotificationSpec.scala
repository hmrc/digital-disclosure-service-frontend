  ...
  "isComplete" - {
    ...
    "must return true where you are the individual and all questions are answered" in {
      ...
      val notification        = Notification(
        ...
        Instant.now,
        Metadata(),
        PersonalDetails(completedBackground, aboutYou, None, None, None, None, None),
        None
      )
    ...
    "must return true where you are NOT the individual and all questions are answered" in {
      ...
      val notification        = Notification(
        ...
        Instant.now,
        Metadata(),
        PersonalDetails(completedBackground, aboutYou, Some(aboutTheIndividual), None, None, None, None),
        None
      )
      notification.isComplete mustBe true
    }
    ...
    "must return true where they are an estate and all questions are answered" in {
      val completedBackground = Background(
        Some(false),
        None,
        Some(DisclosureEntity(Estate, Some(AreYouTheEntity.YesIAm))),
        Some(false),
        None,
        Some(true),
        Some(false),
      ...
      val notification        = Notification(
        ...
        Instant.now,
        Metadata(),
        PersonalDetails(completedBackground, aboutYou, None, None, None, None, Some(aboutTheEstate)),
        None
      )
      notification.isComplete mustBe true
    }
    ...
    "must return true where they are a company and all questions are answered" in {
      val completedBackground = Background(
        Some(false),
        None,
        Some(DisclosureEntity(Company, Some(AreYouTheEntity.YesIAm))),
        Some(false),
        None,
        Some(true),
        Some(false),
      ...
      val notification        = Notification(
        ...
        Instant.now,
        Metadata(),
        PersonalDetails(completedBackground, aboutYou, None, Some(aboutTheCompany), None, None, None),
        None
      )
      notification.isComplete mustBe true
    }
    ...
    "must return true where they are a trust and all questions are answered" in {
      val completedBackground = Background(
        Some(false),
        None,
        Some(DisclosureEntity(Trust, Some(AreYouTheEntity.YesIAm))),
        Some(false),
        None,
        Some(true),
        Some(false),
      ...
      val notification        = Notification(
        ...
        Instant.now,
        Metadata(),
        PersonalDetails(completedBackground, aboutYou, None, None, Some(aboutTheTrust), None, None),
        None
      )
      notification.isComplete mustBe true
    }
    ...
    "must return true where they are a LLP and all questions are answered" in {
      ...
      val notification        = Notification(
        ...
        Instant.now,
        Metadata(),
        PersonalDetails(completedBackground, aboutYou, None, None, None, Some(aboutTheLLP), None),
        None
      )
      notification.isComplete mustBe true
    }
