...
trait AddressLookupHelper {
  ...
  def constructYourAddressRequest(afterHeadingText: Option[String]) = {
    val englishLabels = languageLabels(
      englishMessages,
      "yourCountryLookup",
      "yourAddressLookup",
      "selectAddress",
    ...
    val welshLabels   = languageLabels(
      welshMessages,
      "yourCountryLookup",
      "yourAddressLookup",
      "selectAddress",
  ...
  def yourAddressIndividualBodyRequest = constructYourAddressRequest(
    Some("yourAddressLookup.individual.afterHeadingText")
  )
  ...
  def individualLookupRequest = {
    val englishLabels = languageLabels(
      englishMessages,
      "individualCountryLookup",
      "individualAddressLookup",
      "selectIndividualAddress",
      "editIndividualAddress",
      "confirmIndividualAddress"
    )
    val welshLabels   = languageLabels(
      welshMessages,
      "individualCountryLookup",
  ...
  def rentalLookupRequest = {
    val englishLabels = languageLabels(
      englishMessages,
      "yourCountryLookup",
      "addressLookup.rental",
      "selectAddress.rental",
      "editAddress.rental",
      "confirmAddress.rental",
